...
public:
	...
	NMAILXML_API static bool IsNotesCondition(LPMESSAGE pmsg, const _TCHAR *condition, HRESULT *error);
	NMAILXML_API static bool CheckAttachmentExists(LPMESSAGE pmsg, HRESULT *error);
