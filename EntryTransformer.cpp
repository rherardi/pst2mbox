...
bool const CEntryTransformer::GetLotusDocField()
{
	return m_lotusDocField;
}
void CEntryTransformer::SetLotusDocField(const bool lotusDocField)
{
	m_lotusDocField = lotusDocField;
}
